...
- **Fast decode mode**: set `ENGINE_FAST_DECODE=1` to use the HF streaming/generate path inside mini-sglang, eliminating Python per-token overhead for maximum throughput.
