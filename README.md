...
Set `MODEL_NAME` env var to load a different HuggingFace causal LM (default: `Qwen/Qwen3-0.6B-Instruct`). Use `MODEL_LOCAL_DIR` to point at a pre-downloaded path if you want to avoid hub downloads.
